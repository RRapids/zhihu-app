		...
		<div class="nav-bar shadow mb-2 fill-white">
			<transition name="nav-bar">
				<div class="container row" v-if="fixed">
					...
					<ul class="row fruid-col-3 justify-content-around">
						<li>
					...
					<div class="d-flex fruid-col-5 align-items-center pl-4">
						<div class="search-box mr-2" @click="popUp = !popUp" contenteditable="true">武汉加油</div>
						<transition name="fade">
							<div class="search-container border" v-if="popUp">
					...
					<div class="fruid-col-3 d-flex justify-content-end align-items-center">
						...
						<img :src="user.avatar" v-if="token" 
						width="30" height="30" class="tiny-round link ml-5"
			...
			<transition name="hide-bar">
				<div class="container row justify-content-around  hide-bar" v-if="!fixed">
					...
					<div class="fruid-col-3 d-flex justify-content-end align-items-center">
						<input type="text" placeholder="请输入关键词" class="input-box mr-2" maxlength="100" />
						<button class="blue-fill-btn">提问</button>
					</div>
				</div>
			</transition>
